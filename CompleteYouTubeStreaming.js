...
const YOUTUBE_COOKIES = {
  ...
  '__Secure-3PSID':
    'g.a0003QhBnuBeHjuM-MtLrMMgP2oJ1_uOi3hp6oJ30AFbBfME6_9AFslfCs4OauMpOTqZT_armwACgYKAR8SARUSFQHGX2MizrDBYLrBDR_IvOM0-Ub7QxoVAUF8yKrY_Oi2ehHK0TrDgKbbDGcf0076',
  LOGIN_INFO:
    'AFmmF2swRAIgQBPF4ARFZOd39htEyo7Hcgm63EYkjcATSyul9e03LhkCIDW7MqL5FnlTYkKzl-zLC7whJZxRBxjjLKnedDGaOkuS:QUQ3MjNmd0JNRzA2RlZ6TW5aa3Vmem5EMy1CTUNtWkhHODQxNmhfdVBCV243YXdOc3ZId1huUER0cUc1V3E1T1h6V1NOM0FrNVpQbUhvejllazJlbDU2NkdNT0Fvb2VRQ0xnLU1UTUk5X00tUGQ1bFp2dFR4a2RCVEplX3VvOU1UaEd4ZVdqQ3p5MVhFeHBWZGk4R1kwUUdaQ1Z6YXV0SDJn',
  SIDCC:
    'AKEyXzV0d4EdZUpL3-bfOcGTepXjoPAllD8CnPh1Kh_yVZEfQWDcnaJU4zp8zBt8EbJa-iCOMB0',
};
...
const ANDROID_CLIENT = {
  ...
  headers: {
    ...
    Cookie: Object.entries(YOUTUBE_COOKIES)
      .map(([k, v]) => `${k}=${v}`)
      .join('; '),
  },
};
...
async function getStreamingUrl(videoId) {
  ...
  try {
    ...
    if (data.playabilityStatus?.status !== 'OK') {
      throw new Error(
        `Video not playable: ${
          data.playabilityStatus?.reason || 'Unknown reason'
        }`
      );
    }
    ...
    if (!bestFormat.url) {
      throw new Error(
        'Failed to extract direct URL (Ciphered signatures not supported in this simple version)'
      );
    }
