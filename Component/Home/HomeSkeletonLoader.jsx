...
export const HomeSkeletonLoader = ({ source = 'Hybrid' }) => {
    ...
    const AlbumCardSkeleton = () => (
        <View style={[styles.albumCardContainer, { width: albumCardSize, height: albumCardSize }]}>
            <Animated.View
                style={[
                    styles.albumCardImage,
                    { opacity: shimmerOpacity }
                ]}
            />
            <LinearGradient
