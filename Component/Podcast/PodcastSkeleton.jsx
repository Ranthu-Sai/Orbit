...
export const PodcastSkeleton = () => {
  ...
  const EpisodeCardSkeleton = () => (
    <View style={[styles.episodeCard, { width: episodeCardWidth }]}>
      <Animated.View
        style={[styles.episodeImage, { opacity: shimmerOpacity }]}
      />
  ...
  const CategorySkeleton = ({ width }) => (
    <Animated.View
      style={[styles.categoryChip, { width, opacity: shimmerOpacity }]}
    />
  );
  ...
  const PodcastCardSkeleton = ({ width = 140, noMargin = false }) => (
    <View
      style={[styles.podcastCard, { width, marginRight: noMargin ? 0 : 12 }]}
    >
      <Animated.View
        style={[
          styles.podcastImage,
          { width, height: width, opacity: shimmerOpacity },
        ]}
      />
      <Animated.View
        style={[
          styles.textLine,
          { width: '80%', height: 14, marginTop: 8, opacity: shimmerOpacity },
        ]}
      />
      <Animated.View
        style={[
          styles.textLine,
          { width: '50%', height: 12, marginTop: 2, opacity: shimmerOpacity },
        ]}
      />
    </View>
  );
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.topHeader}>
        ...
        <Animated.View
          style={[styles.backButton, { opacity: shimmerOpacity }]}
        />
        {/* Title Placeholder */}
