    ...
    return (
      ...
      >
        ...
        <List.Item
          ...
          left={(props) => (
            <List.Icon {...props} icon="format-size" color="#FFFFFF" />
          )}
          right={() => (
            <View style={styles.row}>
              ...
              />
              <Text
                style={{ color: '#FFFFFF', marginHorizontal: 8, fontSize: 16 }}
              >
                {fontSize}
              </Text>
              <IconButton
        ...
        <List.Item
          ...
          left={(props) => (
            <List.Icon {...props} icon="refresh" color="#FFFFFF" />
          )}
          onPress={() => {
            onClose();
...
const LyricsPage = ({
  ...
  const fadeGradientColorsReverse = [
    'transparent',
    'transparent',
    'transparent',
  ];
  ...
  const renderItem = useCallback(
    ({ item, index }) => {
      ...
      const distance =
        activeLineIndex >= 0 ? Math.abs(index - activeLineIndex) : 0;
      ...
      <GestureHandlerRootView style={{ flex: 1 }}>
        ...
        >
          ...
          <LinearGradient
            ...
            style={[
              styles.topFade,
              { top: HEADER_HEIGHT + HEADER_PADDING_TOP },
            ]}
            pointerEvents="none"
          />
          <LinearGradient
            ...
            style={[
              styles.bottomFade,
              { bottom: CONTROLS_HEIGHT + CONTROLS_PADDING_BOTTOM },
            ]}
            pointerEvents="none"
          />
