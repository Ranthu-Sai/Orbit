...
export const DiscoverSkeletonLoader = () => {
    ...
    return (
        <ScrollView
            style={[styles.container, { backgroundColor: dark ? colors.background : '#FFFFFF' }]}
            showsVerticalScrollIndicator={false}
            contentContainerStyle={styles.contentContainer}
        >
            {/* Route Heading placeholder */}
            <View style={styles.routeHeading}>
                <Animated.View style={[styles.routeHeadingText, { opacity: shimmerOpacity }]} />
                <Animated.View style={[styles.routeHeadingSubtext, { opacity: shimmerOpacity }]} />
            </View>
...
export const AlbumRowSkeleton = ({ count = 4 }) => {
    ...
    return (
        <ScrollView
            horizontal
            showsHorizontalScrollIndicator={false}
            contentContainerStyle={{ paddingVertical: 8, gap: 12, flexDirection: 'row' }}
        >
