...
import { View, Animated, Dimensions, ScrollView, StyleSheet, StatusBar } from 'react-native';
        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            >
                ...
                <View style={styles.section}>
                    ...
                    <View style={[styles.bioContainer, { backgroundColor: dark ? '#1a1a1a' : '#f0f0f0' }]}>
                        <Animated.View style={[styles.bioLine, { width: '100%', opacity: shimmerOpacity }]} />
                        <Animated.View style={[styles.bioLine, { width: '95%', opacity: shimmerOpacity }]} />
                        <Animated.View style={[styles.bioLine, { width: '90%', opacity: shimmerOpacity }]} />
                        <Animated.View style={[styles.bioLine, { width: '85%', opacity: shimmerOpacity }]} />
                    </View>
                </View>
            </ScrollView>
        </View>
